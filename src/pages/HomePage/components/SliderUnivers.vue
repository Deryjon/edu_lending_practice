<template>
    <div class="slider pb-[100px] w-full"  ref="slider" @touchstart="onTouchStart" @touchend="onTouchEnd">
      ...
      <button class="slider-control slider-prev hidden lg:block w-12 h-12 rounded-full border-none mt-[-50px] p-[5px]" @click="slidePrev">
      ...
      <button class="slider-control slider-next hidden lg:block w-12 h-12 rounded-full border-none mt-[-50px] p-[5px]" @click="slideNext">
        <div class="hidden lg:block w-[38px] h-[38px] rounded-full border-none pl-3 pt-3">
