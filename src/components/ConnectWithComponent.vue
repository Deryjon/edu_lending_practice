<template>
  ...
  >
    ...
    <div class="container lg:relative">
      ...
      <div
        class="flag-img hidden xl:flex lg:absolute lg:left-[-20px] lg:top-[-80px]"
      >
        <img src="../assets/icons/flag-connect.svg" alt="" />
      </div>
      <div
        class="img-girl hidden xl:flex lg:absolute lg:bottom-[-550px] lg:left-[150px]"
      >
        <img src="../assets/icons/girl-connect.svg" alt="" />
      </div>
      <div
        class="img-girl-niz hidden xl:flex lg:absolute lg:top-[480px] lg:left-[130px]"
      >
      ...
      >
        ...
        >
          <div class="text mt-2 lg:mt-6 lg:w-[331px] lg:ml-auto lg:mr-auto">
            ...
            <p
              class="subtitle lg:mt-3 text-[10px] lg:text-[14px] text-gray text-center"
            >
          ...
          <div class="inputs flex flex-col gap-2 items-center mt-2">
            ...
            >
              <div
                class="icon w-[10px] lg:w-[14px] h-[10px] lg:h-[14px] mb-auto"
              >
                <img
    ...
    <div class="bg-img min-h-screen w-full lg:hidden">
      <div class="icon-tree pt-14">
        <img src="../assets/icons/tree-icon-2.svg" alt="" />
      </div>
    </div>
  </section>
</template>
...
@media screen and (min-width: 641px) {
  .connect {
    ...
    box-shadow: 0px -20px 40px 0px rgba(119, 205, 255, 0.3);
